...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.messageId = [[[NSUUID UUID] UUIDString] lowercaseString];
        self.messageType = SSChatMessageTypeText;
        self.textColor   = SSChatTextColor;
        self.cellString  = SSChatTextCellId;
    }
    return self;
}
