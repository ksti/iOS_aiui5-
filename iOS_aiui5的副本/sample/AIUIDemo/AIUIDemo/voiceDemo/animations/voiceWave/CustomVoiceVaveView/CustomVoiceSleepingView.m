...
@interface CustomVoiceSleepingView ()
...
@implementation CustomVoiceSleepingView {
...
- (void)addAnimationToSecondCircle
{
    ...
    //透明度
    CAKeyframeAnimation *opacity = [self opacityAnimation];
